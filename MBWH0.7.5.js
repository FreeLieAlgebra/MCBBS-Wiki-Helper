...
function editPage(title, summary, minor, text, csrftoken){
    $.ajax({url:"/api.php?action=edit&format=json", type:"POST", data: {title: title, summary: summary, minor: minor, basetimestamp: "now", text: changedText, token: csrftoken}});
}
